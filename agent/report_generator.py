...
def _gh_request(
    ...
    headers = {
        ...
        "User-Agent": "night-pr-reviewer-report",
    }
...
def build_fallback_report(
    ...
    md = (
        ...
        f"---\n*Generated by Night PR Reviewer (fallback — model unavailable)*\n"
    )
    return {
...
def format_pr_comment(
    ...
    return (
        ...
        f"{preview_line}\n"
        f"---\n"
        f"*Full report available in Night PR Reviewer dashboard*"
    )
